...
const char* ssid     = "2x+5y-8=14";   //your network SSID
const char* password = "11445566";   //your network password

String myScript = "/macros/s/AKfycbwOoKO8o6awyxHWnGghLIMEFMm1TnAEoNr9OKq8VAd-wNx7cAg/exec";    //Create your Google Apps Script and replace the "myScript" path.
...
String myFilename = "&myFilename=KWH MUTAHAR.jpg";
